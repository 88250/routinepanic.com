...
CodeMirror.extendMode("css",{commentStart:"/*",commentEnd:"*/",newlineAfterToken:function(e,t){return/^[;{}]$/.test(t)}}),CodeMirror.extendMode("javascript",{commentStart:"/*",commentEnd:"*/",newlineAfterToken:function(e,t,n,o){return this.jsonMode?/^[\[,{]$/.test(t)||/^}/.test(n):(";"!=t||!o.lexical||")"!=o.lexical.type)&&/^[;{}]$/.test(t)&&!/^;/.test(n)}}),CodeMirror.extendMode("xml",{commentStart:"\x3c!--",commentEnd:"--\x3e",newlineAfterToken:function(e,t,n){return"tag bracket"==e&&/>$/.test(t)||/^</.test(n)}}),CodeMirror.defineExtension("commentRange",function(o,r,i){var a=this,s=CodeMirror.innerMode(a.getMode(),a.getTokenAt(r).state).mode;a.operation(function(){if(o)a.replaceRange(s.commentEnd,i),a.replaceRange(s.commentStart,r),r.line==i.line&&r.ch==i.ch&&a.setCursor(r.line,r.ch+s.commentStart.length);else{var e=a.getRange(r,i),t=e.indexOf(s.commentStart),n=e.lastIndexOf(s.commentEnd);-1<t&&-1<n&&t<n&&(e=e.substr(0,t)+e.substring(t+s.commentStart.length,n)+e.substr(n+s.commentEnd.length)),a.replaceRange(e,r,i)}})}),CodeMirror.defineExtension("autoIndentRange",function(t,n){var o=this;this.operation(function(){for(var e=t.line;e<=n.line;e++)o.indentLine(e,"smart")})}),CodeMirror.defineExtension("autoFormatRange",function(n,o){var r=this,e=r.getMode(),t=r.getRange(n,o).split("\n"),i=CodeMirror.copyState(e,r.getTokenAt(n).state),a=r.getOption("tabSize"),s="",c=0,d=0==n.ch;function m(){s+="\n",d=!0,++c}for(var l=0;l<t.length;++l){for(var f=new CodeMirror.StringStream(t[l],a);!f.eol();){var g=CodeMirror.innerMode(e,i),u=e.token(f,i),M=f.current();f.start=f.pos,d&&!/\S/.test(M)||(s+=M,d=!1),!d&&g.mode.newlineAfterToken&&g.mode.newlineAfterToken(u,M,f.string.slice(f.pos)||t[l+1]||"",g.state)&&m()}!f.pos&&e.blankLine&&e.blankLine(i),d||m()}r.operation(function(){r.replaceRange(s,n,o);for(var e=n.line+1,t=n.line+c;e<=t;++e)r.indentLine(e,"smart");r.setSelection(n,r.getCursor(!1))})});
